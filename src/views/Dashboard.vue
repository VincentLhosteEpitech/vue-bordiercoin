        ...
        <div class="row">
          <div class="col-lg-4 text-center " id="user-dashboard-menu">
            ...
            <div class="user-dashboard-profile">
              ...
              <p class="enlightened">{{ this.currentUser.payroll }} Bordier Coins</p>
            </div>

            <div class="user-dashboard-menu text-left">
              <ul>
                 <li class="" v-on:click="updateAccountMenu">
                  <a href="#" class="dashboard-sidebar"><i></i>Modifier mon compte utilisateur</a>
                </li>
                <li v-on:click="retailerRegisterMenu" >
                  <a href="#" class="dashboard-sidebar"><i></i>Editer un compte commerçant</a>
                </li>
                <li v-on:click="paimentMenu">
                  <a href="#" class="dashboard-sidebar"><i></i>Solde Ethicoins</a>
                </li>
                <li @click="deleteAccount">
                  <a href="#" class="dashboard-sidebar"><i></i>Supprimer mon compte</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-8 text-left userfield" id="dashboard">
            <br><br>
